...
# Kernel
BOARD_KERNEL_CMDLINE := bootopt=64S3,32N2,64N2 androidboot.selinux=permissive androidboot.configfs=true buildvariant=eng
...
#System as root
BOARD BUILD SYSTEMROOT_IMAGE:=false

#fstab
TARGET_RECOVERY_FSTAB :S(DEVICE_PATH)/recovery.fstab
TARGET_RECOVERY_WIPE :S(DEVICE_PATH)/recovery.wipe
...
#Bootloader
TARGET_BOOTLOADER_BOARD_NAME:=lotus
